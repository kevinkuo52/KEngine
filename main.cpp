...
public:
    ...
    const std::string MODEL_PATH = "SceneAsset/Model/viking_room.obj";
    const std::string TEXTURE_PATH = "SceneAsset/Model/viking_room.png";
...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("Renderer/Shader/vert.spv");
        auto fragShaderCode = readFile("Renderer/Shader/frag.spv");
    ...
    VkImageView createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
        ...
        if (vkCreateImageView(device, &viewInfo, nullptr, &imageView) !=
            VK_SUCCESS) {
            throw std::runtime_error("failedtocreatetextureimageview!");
    ...
    void createTextureSampler() {
        ...
        vkGetPhysicalDeviceProperties(physicalDevice, &properties); // consider retriver this in begining of program
    ...
    void createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
        ...
        // TODO: should use VulkanMemoryAllocator library instead of calling alloc on every buffer creation
        // in fact, should store multiple buffers, like the vertex and index buffer, into a single VkBuffer
        // and use offsets in commands like vkCmdBindVertexBuffers. This way it is more cache friendly as it is closer together
    ...
    VkCommandBuffer beginSingleTimeCommands() {
        ...
        allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
        allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
        // TODO: create seperate command pool for short lived buffers so we can apply optimization on mem alloc with VK_COMMAND_POOL_CREATE_TRANSIENT_BIT
        allocInfo.commandPool = commandPool;
